 ...
 */
public class NewBookedFragment extends Fragment {
    ...
    private NewBookedAdapter newBookedAdapter;

    private Context context;
    private View view;

    public NewBookedFragment() {
...
//        this.sensorAreas = sensorAreas;
        ...
        newBookedAdapter = new NewBookedAdapter(context, this);
        recyclerViewBooking.setAdapter(newBookedAdapter);
    }
}
